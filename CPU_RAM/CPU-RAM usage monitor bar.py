"""Головний модуль. Модуль створює GUI та події програми."""
...
class Application(tk.Tk, Configure_widjets):
    ...
    def run_set_ui(self):
        """Почати будівництво widgets."""
        self.set_ui()
        self.make_bar_cpu_usage()
        self.configure_cpu_bar()

    def set_ui(self):
        """Побудова базова widgets and events."""
    ...
    def make_bar_cpu_usage(self):
        """Створення індикаторів прогресу та міток для вказівки завантаження CPU and RAM."""
        ttk.Label(self.bar,
    ...
    def choise_combo(self, event):
        """
        ComboboxSelected подія.
        Переривання циклу оновлення віджетів.
        Відключення подій, видалення віджетів.
        Створення невеликих віконних віджетів.
        """
    ...
    def make_full_win(self): 
        """
        Переривання циклу оновлення віджетів.
        Видалення маленьких віконних віджетів.
        Оновлення основного GUI.
        """
        self.after_cancel(self.wheel)
        self.clear_win()
        self.update()
